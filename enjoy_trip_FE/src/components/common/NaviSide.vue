    ...
    <b-container>
      <div>
        <b-nav ref="tabNav">
          ...
          <b-nav-item @click="tog('/attraction')">관광지</b-nav-item>
          <b-nav-item @click="tog('/tourboard')">여행계획</b-nav-item>
          <b-nav-item @click="tog('/community')">자유게시판</b-nav-item>
        </b-nav>
      </div>
    </b-container>
  </b-nav>
...
.nav-tabs .nav-link.active {
  border-color: white;
  border-bottom: 3px solid #F4E04E;
  font-weight: 700;
}
</style>
